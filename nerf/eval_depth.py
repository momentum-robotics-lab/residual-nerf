...
def rmse_mae_test(prinout = True):
    ...
    scenes = ['/home/splatting/depth_eval_test/wine_down']
    #DEBUG
    #pdb.set_trace()
    ...
    # scene names
    # 'shelf','clutter','bowl','drink_flat','drink_up','needles_flat','needles_up','scissors_flat','scissors_up','wine_up',
    scenes_names = ['wine_down']
    ...
    RMSE_results = (nerf_mean, dex_mean, residual_mean)
    ...
    MAE_results = (nerf_mean, dex_mean, residual_mean)
    if (prinout):
        print("Residual-NeRF is {} % better than NeRF".format((nerf_mean-residual_mean)/nerf_mean * 100))
        print("Residual-NeRF is {} % better than Dex-NeRF".format((dex_mean-residual_mean)/dex_mean * 100))
