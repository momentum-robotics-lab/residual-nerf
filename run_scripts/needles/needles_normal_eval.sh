...
python3 main_nerf.py data/needles --workspace needles_normal -O --dt_gamma 0  --iters $ITERATIONS --type wrap --d_thresh 3.5 --test --d_thresh 2.5 --mixnet_reg 10.0 --aabb_infer -0.6 0.12 -0.25 0.22 -0.54 0.28 
