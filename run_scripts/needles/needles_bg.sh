...
python3 main_nerf.py data/needles --workspace needles_bg -O --dt_gamma 0  --iters $ITERATIONS --type bg --d_thresh 3.5 \
--ckpt scratch --wandb --wandb_name needles_bg --wandb_project needles
