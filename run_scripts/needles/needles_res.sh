...
python3 main_nerf.py data/needles --workspace needles_res -O --dt_gamma 0 --iters $ITERATIONS --type wrap --bg_ckpt $BG_CHECKPOINT --d_thresh 2.5 --mixnet_reg 10.0 \
--ckpt scratch --wandb --wandb_name needles_res --wandb_project needles
