...
python3 main_nerf.py data/needles --workspace needles_normal -O --dt_gamma 0  --iters $ITERATIONS --type wrap --d_thresh 3.5 \
--ckpt scratch --wandb --wandb_name needles_normal --wandb_project needles  
