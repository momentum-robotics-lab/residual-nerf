...
python3 main_nerf.py data/dslr_bakje_wrap --workspace dslr_bakje_wrap_normal -O --dt_gamma 0  --iters $ITERATIONS --type wrap --d_thresh 2.0 --downscale 4.0 --min_near 0.2  \
--ckpt scratch --wandb --wandb_name dslr_bakje_wrap_normal --wandb_project dslr_bakje_wrap 
