...
python3 main_nerf.py data/drink --workspace drink_normal -O --dt_gamma 0  --iters $ITERATIONS --type wrap --d_thresh 3.5 \
--ckpt scratch --wandb --wandb_name drink_normal --wandb_project drink  
