...
python3 main_nerf.py data/dslr_wine --workspace dslr_wine_normal_highres -O --dt_gamma 0  --scale 1.0 --bound 6.0 --iters $ITERATIONS --type wrap --d_thresh 2.0 --downscale 4.0 --min_near 0.2  \
--ckpt scratch --wandb --wandb_name dslr_wine_normal_highres_scale --wandb_project dslr_wine 
