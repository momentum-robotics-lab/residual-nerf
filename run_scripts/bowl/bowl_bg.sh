...
python3 main_nerf.py data/bowl --workspace bowl_bg -O --dt_gamma 0  --iters $ITERATIONS --type bg --d_thresh 3.5 \
--ckpt scratch --wandb --wandb_name bowl_bg --wandb_project bowl  
