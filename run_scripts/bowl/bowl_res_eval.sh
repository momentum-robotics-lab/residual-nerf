...
python3 main_nerf.py data/bowl --workspace bowl_res -O --dt_gamma 0 --iters $ITERATIONS --type wrap --bg_ckpt $BG_CHECKPOINT --test --d_thresh 2.5 --aabb_infer -1 1 -1 1 -1 1 
