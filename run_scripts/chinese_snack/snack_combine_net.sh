...
python3 main_nerf.py data/chinese_snack --workspace lego_res -O --bound 1 --scale 0.8 --dt_gamma 0 --iters $ITERATIONS --type wrap  --combine_net --gui 
# --ckpt scratch \
# --bg_ckpt $BG_CHECKPOINT 
