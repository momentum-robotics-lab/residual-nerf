...
python3 main_nerf.py data/chinese_snack --workspace snack_res -O --bound 1 --scale 0.8 --dt_gamma 0 --iters $ITERATIONS --type wrap --test --d_thresh 2.5 --aabb_infer -1 1 -1 1 -1 1 --bg_ckpt $BG_CHECKPOINT
