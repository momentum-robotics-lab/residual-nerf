...
python3 main_nerf.py data/chinese_snack --ckpt scratch --workspace snack_res -O --bound 1 --scale 0.8 --dt_gamma 0 --iters $ITERATIONS --type wrap --bg_ckpt $BG_CHECKPOINT --d_thresh 3.0 \
--wandb --wandb_name snack_res_sigmaonly --wandb_project chinese_snack
