...
python3 main_nerf.py data/lab_dslr --workspace lab_dslr_res_bgsigma -O --dt_gamma 0 --iters $ITERATIONS --bg_ckpt $BG_CHECKPOINT --type wrap --d_thresh 2.5 --downscale 4.0 --min_near 0.2 \
--ckpt scratch --wandb --wandb_name lab_dslr_res --wandb_project lab_dslr 
