...
python3 main_nerf.py data/dex-clutter --workspace dex_clutter_normal -O --bound 1 --scale 0.8  --dt_gamma 0 --iters $ITERATIONS --type wrap --ckpt scratch \
--wandb --wandb_name clutter_normal_bound_thresh_20 --wandb_project clutter 
# --gui
# 
# 
