...
python3 main_nerf.py data/clutter --workspace clutter_res -O --bound 4 --scale 0.8  --dt_gamma 0 --iters $ITERATIONS --type wrap  --bg_ckpt $BG_CHECKPOINT --ckpt scratch \
--wandb --wandb_name clutter_res --wandb_project clutter 
# --ckpt scratch
# 
# --gui
# 
