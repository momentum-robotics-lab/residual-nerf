...
python3 main_nerf.py data/vase --workspace vase_normal -O --dt_gamma 0  --iters $ITERATIONS --type wrap --d_thresh 3.5 \
--ckpt scratch --wandb --wandb_name vase_normal_bgsigma --wandb_project vase 
