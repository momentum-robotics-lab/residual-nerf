...
python3 main_nerf.py data/bowl_hard --workspace bowl_hard_normal -O --dt_gamma 0  --iters $ITERATIONS --type wrap --d_thresh 3.5 \
--ckpt scratch --wandb --wandb_name bowl_normal --wandb_project bowl_hard  
