...
python3 main_nerf.py data/bowl_hard --workspace bowl_hard_normal  -O --dt_gamma 0  --iters $ITERATIONS --type wrap --test --d_thresh 2.5 --aabb_infer -0.6 0.12 -0.25 0.22 -0.54 0.28
