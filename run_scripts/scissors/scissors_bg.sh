...
python3 main_nerf.py data/scissors --workspace scissors_bg -O --dt_gamma 0  --iters $ITERATIONS --type bg --d_thresh 3.5 \
--ckpt scratch --wandb --wandb_name scissors_bg --wandb_project scissors
