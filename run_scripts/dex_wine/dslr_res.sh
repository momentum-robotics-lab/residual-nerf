...
python3 main_nerf.py data/dslr_wine --workspace dslr_wine_res -O --dt_gamma 0  --bg_ckpt $BG_CHECKPOINT --iters $ITERATIONS --type wrap --d_thresh 2.0 --downscale 4.0 --min_near 0.2  \
--ckpt scratch --wandb --wandb_name dslr_wine_res_0.2 --wandb_project dslr_wine 
